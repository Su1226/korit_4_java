...
public class StrList {
    public static void main(String[] args) {
        ...
        // element으 일부만 가지고 삭제하는 것이 불가능하다.
        // (일부로 element 전체 삭제 불가능, 또한 removeElem2 = "py"로 했을 때 -> sout(strList) 결과값 중 element로 "py"만 삭제하고 "thon"만 남는 것이 불가능하다.)
        ...
        // 배열과 유사하게 element들을 다 출력할 수 있다.

        // 예시) python 언어 java 언어 JavaScript 언어 C# 언어로 출력될 수 있도록 작성하시오.
        // 참고 : strList1.length는 통하지 않는다.
